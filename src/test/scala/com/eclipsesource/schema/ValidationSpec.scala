...
////    }
//
//    "validate mutual recursive schema definitions" in {
//      lazy val schema = qbClass(
//        "a" -> $ref("b"),
//        "b" -> $ref("a")
//      )
//
////      var bar: JsValue = JsUndefined("")
////      var itemA: JsValue = Json.obj()
//      lazy val itemA = Json.obj("b" -> itemB)
//      lazy val itemB: JsValue = Json.obj("a" -> itemA)
//
//      val s = schema
//      val z = Validator.validate(s)(itemA)
//      println(">> " + z)
//
//      Validator.validate(schema, itemA).isSuccess must beTrue
//    }
//
////
